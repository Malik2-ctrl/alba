          ...
          {size.width >= 724 && (
            <div className="flex p-4 fixed bottom-12 bg-white w-full">
              ...
              <div className="ml-16 text-sm font-satoshithin">
                End-to-end production (storyboarding, interviewing, filming and editing)
                of a mini-documentary about the plasticine artist Wilfrid Wood.
              </div>
            </div>
          )}
        </>
      ...
      {size.width < 724 && (
        <section className="flex mt-2 p-4 flex-col gap-3">
          ...
          <p className="text-sm font-satoshithin">
            End-to-end production (storyboarding, interviewing, filming and editing) of a
            mini-documentary about the plasticine artist Wilfrid Wood.
          </p>
          {children}
          <div></div>
        </section>
